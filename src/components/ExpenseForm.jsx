...
export default function ExpenseForm({ cards, expenses, onAdd, onAddCard, onSaved }) {
  ...
  useEffect(() => {
    if (!cartao && cards.length) setCartao(cards[0]);
  }, [cards, cartao]);
  ...
  return (
    <div className="card tab-enter">
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
        <p className="section-title" style={{ marginBottom: 0 }}>Novo gasto</p>
        <button
          type="button"
